...
module Kebapress
  class PostsController < ApplicationController
    ...
    def index
      ...
      render layout: Rails.configuration.kebapress.front_layout, template: 'kebapress/blog/index'
    end

    def show
      @post = Kebapress::Post.find(params[:id])
      render layout: Rails.configuration.kebapress.front_layout, template: 'kebapress/blog/show'
    end
